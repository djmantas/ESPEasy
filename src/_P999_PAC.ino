#ifdef USES_P999
//#######################################################################################################
//######################## Plugin 999: Temperature and Humidity sensor DHT 12 (I2C) #####################
//#######################################################################################################
...
#define PLUGIN_NAME_999       "PAC"
#define PLUGIN_VALUENAME1_999 "Temperature"
#define PLUGIN_VALUENAME2_999 "Humidity"

boolean Plugin_999_init = false;

#define DHT12_I2C_ADDRESS      0x5C // I2C address for the sensor

boolean Plugin_999(byte function, struct EventStruct *event, String& string)
{
